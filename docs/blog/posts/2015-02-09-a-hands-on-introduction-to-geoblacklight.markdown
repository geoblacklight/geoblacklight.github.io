...
!!! warning
    ...
    This tutorial was designed for GeoBlacklight versions before 4.0 and may be outdated. Please refer to the [Documentation pages](https://geoblacklight.org/documentation) for up to date instructions.
...
1. SSH into the Vagrant box by entering the following parameters into the "Basic Options for Your PuTTY session" window: - Host Name (or IP address): 127.0.0.1 - Port: 2222
...
1. _Optional_ Initialize your git repository and commit your changes
