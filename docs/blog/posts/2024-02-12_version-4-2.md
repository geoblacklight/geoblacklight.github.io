...
- **New or updated pages**
    - [For Developers](https://geoblacklight.org/docs/latest/developers/): Added more details and a diagram for new developers
    - [User Authentication](https://geoblacklight.org/docs/latest/user_authentication/): New page about configuring user accounts and logins
    - [JSONs and GeoJSONs](https://geoblacklight.org/docs/latest/json-geojson/): New page clarifying the difference between the file formats
...
We also plan to upgrade to Bootstrap v5 and Blacklight v8.  [Review our Release Calendar for more details.](../../releases.md)
