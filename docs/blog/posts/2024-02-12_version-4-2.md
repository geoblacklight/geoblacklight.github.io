...
- **New or updated pages**
  - [For Developers](../../documentation/developers.md): Added more details and a diagram for new developers
  - [User Authentication](../../documentation/user_authentication.md): New page about configuring user accounts and logins
  - [JSONs and GeoJSONs](../../documentation/json-geojson.md): New page clarifying the difference between the file formats
...
We also plan to upgrade to Bootstrap v5 and Blacklight v8. [Review our Release Calendar for more details.](../../documentation/releases.md)
