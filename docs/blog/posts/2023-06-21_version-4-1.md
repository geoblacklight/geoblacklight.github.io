...
- New information on our Getting Started page about [using an external Solr instance.](https://geoblacklight.org/documentation/installation/getting_started_developers/)
- New guide for [configuring the Settings (`settings.yml`) file](https://geoblacklight.org/documentation/configuration/settings/) to set the logo, default paths, and other local customizations.
- New page for configuring the [Catalog Controller (`catalog_controller.rb`) file](https://geoblacklight.org/documentation/configuration/catalog_controller/) to customize facets, metadata fields, search behavior, and basemaps.
- Clarifications to the [Upgrading to 4.0 Guide](https://geoblacklight.org/documentation/upgrading/Upgrading_to_version_4_0/) that list the item relationships to display.
