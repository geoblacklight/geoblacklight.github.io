...
Keep in mind, GeoBlacklight has reasonable defaults for all settings, so you do not need to change anything in order to get up and running. That said, you will _eventually_ need to change _something_. Below is an annotated list of all variables in the settings file.
